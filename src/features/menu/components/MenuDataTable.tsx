...
export function MenuDataTable({
  ...
  const columns: ColumnDef<MenuItem>[] = [
    ...
    },
    {
        ...
        header: "Category",
        cell: ({ row }) => {
            const catId = row.getValue("category_id") as string
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => onEdit(payment)}>Edit Item</DropdownMenuItem>
              <DropdownMenuItem onClick={() => onDelete(payment)} className="text-red-600 focus:text-red-600">Delete Item</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        )
      },
