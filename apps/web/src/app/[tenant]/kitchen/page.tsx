...
// Lazy load heavy KDS component
const KitchenBoard = nextDynamic(
  () => import('@/features/kds/components/KitchenBoard').then(mod => mod.KitchenBoard),
  {
    loading: () => (
      <div className="flex-1 p-6 grid grid-cols-2 gap-4 animate-pulse">
